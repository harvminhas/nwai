...
import {
  buildExpectedUpcomingItems,
  DEFAULT_WHAT_WE_EXPECT_HORIZON_DAYS,
  normKeyExpected,
} from "@/lib/expectedUpcoming";
...
import type { UpcomingItem, UpcomingItemType } from "@/lib/expectedUpcoming";

export type { UpcomingItem, UpcomingItemType };
...
export async function GET(req: NextRequest) {
  ...
  const upcoming = buildExpectedUpcomingItems({
    horizonDays: DEFAULT_WHAT_WE_EXPECT_HORIZON_DAYS,
    today,
    now,
    thisMonth,
    consolidated,
    ...
    sourceMappings,
    parsedStatements,
    includeCcMinimumEstimates: true,
  });
