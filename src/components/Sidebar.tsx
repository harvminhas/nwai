      ...
      >
        ...
        <div className={`shrink-0 border-b border-gray-100 ${collapsed ? "p-2" : "px-4 py-3"}`}>
          <Link
            ...
            className={`flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs font-semibold text-gray-700 shadow-sm transition hover:bg-gray-50 hover:border-gray-300 ${collapsed ? "justify-center px-2" : ""}`}
          >
          ...
          <aside className="absolute inset-y-0 left-0 flex w-64 flex-col bg-white shadow-xl">
            ...
            <div className="shrink-0 border-b border-gray-100 px-4 py-3">
              <Link
                ...
                className="flex items-center gap-2 rounded-lg border border-gray-200 px-3 py-2 text-xs font-semibold text-gray-700 hover:bg-gray-50 transition"
              >
